      ...
      <section className="plannerLanding">
        <Row className="landing">
          ...
          <p>Pick your location and prepare your trip with simple steps.</p>
            <form>
              <Button color="primary" key="newPlan" id="newPlan" onClick={this.handleButtons}>
                Create New
              </Button>
              <Button color="primary" outline key="editPlan" id="editPlan" onClick={this.handleButtons}>
                Edit Plan
              </Button>
            </form>
          </Col>
