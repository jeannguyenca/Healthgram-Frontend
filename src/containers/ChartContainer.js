...
import prepare_disease from "../img/prepare_disease@1x.svg";
  ...
  render() {
    return <React.Fragment>
        {this.state.selectedOption !== "" ? <React.Fragment>
            ...
            <Suggestions info={this.state.diseases[this.state.selectedOption]} img={prepare_disease} alt={"Prepare for disease"} />
